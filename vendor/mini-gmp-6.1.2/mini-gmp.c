/* mini-gmp-6.1.2, a minimalistic implementation of a GNU GMP subset.
...
/* NOTE: All functions in this file which are not declared in
   mini-gmp-6.1.2.h are internal, and are not intended to be compatible
   neither with GMP nor with future versions of mini-gmp-6.1.2. */
